...
import com.denisassoti.cinema_management.services.interfaces.ProjectionService;
...
public class ProjectionServiceImpl implements ProjectionService{
    ...
    @Override
    public void saveProjection(ProjectionFilm projectionFilm) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public ProjectionFilm getProjectionById(Long id) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
